...
export interface BlockHero {
	...
	date_updated?: string | null;
	user_updated?: DirectusUser | string | null;
	/** @description Embed external URLs here */
...
export interface LiveBlogItem {
	...
	content?: string | null;
	image?: DirectusFile | string | null;
	/** @description Use this if embedding X, Instagram, etc */
	embed_url?: string | null;
	live_blog?: LiveBlog | string | null;
	sort?: number | null;
}
...
export interface LiveBlog {
	...
	summary?: Array<{ summary_item: string }> | null;
	live_blog_items?: LiveBlogItem[] | string[];
}
...
export interface PostComment {
	...
	post: Post | string;
	/** @description Email address of the commenter @required */
	email: string;
	/** @description The comment content @required */
	content: string;
...
export interface ProductCategory {
	...
	/** @required */
	name: string;
	/** @description URL-safe identifier @required */
	slug: string;
	sort?: number | null;
	products?: ProductsProductCategory[] | string[];
}

export interface Product {
	/** @primaryKey */
	id: string;
	status?: 'published' | 'in_review' | 'draft' | 'archived';
	sort?: number | null;
	user_created?: DirectusUser | string | null;
	date_created?: string | null;
	user_updated?: DirectusUser | string | null;
	...
	title: string;
	/** @description URL slug for product pages */
	slug?: string | null;
	/** @description Unique stock keeping unit @required */
	sku: string;
	/** @description Brief excerpt for cards and listings */
	...
	/** @description Highlight on storefront */
	featured?: boolean | null;
	seo?: ExtensionSeoMetadata | null;
	categories?: ProductsProductCategory[] | string[];
}

export interface ProductsProductCategory {
	/** @primaryKey */
	id: string;
	products_id?: Product | string | null;
	product_categories_id?: ProductCategory | string | null;
	sort?: number | null;
}
...
export interface Site {
	...
	pages?: Page[] | string[];
	website_managers?: SitesDirectusUser[] | string[];
}
...
export interface Schema {
	...
	products: Product[];
	products_product_categories: ProductsProductCategory[];
	projects: Project[];
	redirects: Redirect[];
	sites: Site[];
...
export enum CollectionNames {
	...
	globals = 'globals',
	languages = 'languages',
	live_blog_items = 'live_blog_items',
