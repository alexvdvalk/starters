...
export interface Payment {
	...
	user_updated?: DirectusUser | string | null;
	date_updated?: string | null;
	payee?: DirectusUser | string | null;
	amount?: number | null;
	date?: string | null;
}
...
export interface PostsTranslation {
	...
	content?: string | null;
	slug?: string | null;
	language_status?: 'ready' | 'approval' | null;
	/** @description Short summary of the blog post to entice readers. */
	description?: string | null;
}
...
export interface DirectusSettings {
	...
	/** @description Select the collections to include the related items module. @required */
	related_items_collections: 'json';
}
